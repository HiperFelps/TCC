...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                    <button type="button" class="nivel_button" onclick="StartLevel2()">
                        <div class="nivel_locked">
                        2
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#ffa500" class="bi bi-lock-fill" viewBox="0 0 16 16">
            ...
            <div class="col-md-3">
                    <button type="button" class="nivel_button" onclick="StartLevel3()">
                        <div class="nivel_locked">
                        3
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#ffa500" class="bi bi-lock-fill" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M8 0a4 4 0 0 1 4 4v2.05a2.5 2.5 0 0 1 2 2.45v5a2.5 2.5 0 0 1-2.5 2.5h-7A2.5 2.5 0 0 1 2 13.5v-5a2.5 2.5 0 0 1 2-2.45V4a4 4 0 0 1 4-4m0 1a3 3 0 0 0-3 3v2h6V4a3 3 0 0 0-3-3"/>
    ...
    window.onload = function() {
        let numNivel = <?php echo $numNivel; ?>;
        document.querySelectorAll('.nivel_locked').forEach((lock, index) => {
          if (numNivel >= index + 2) {
            lock.innerHTML = (index + 2).toString();
          }
        });
    };
      ...
      function StartLevel1() {
        ...
        function StartLevel2() {
            if(<?php echo $numNivel; ?> < 2){
                alert("Você ainda não desbloqueou esse nível!");
                return;
            }
            window.location.href = "tutorial2.php";
        }
        function StartLevel3() {
            if(<?php echo $numNivel; ?> < 3){
                alert("Você ainda não desbloqueou esse nível!");
                return;
            }
